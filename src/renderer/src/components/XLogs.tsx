...
export function XLogs(): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    const cleanup = window.api.x.onLog((log) => {
      ...
      <div className="flex flex-col items-center max-w-md w-full gap-8">
        ...
        <div className="flex flex-col gap-2">
          <h2 className="text-xl font-bold tracking-tight text-base-content">
            {isRunning ? 'X Autopost Bot is Running' : 'Preparing Bot'}
          </h2>
